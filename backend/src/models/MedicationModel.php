...
class MedicationModel
{
    ...
    public function assign(array $d): int
    {
        $stmt = $this->db->prepare("
            ...
            (patient_id, medication_id, name_override, dosage, frequency_per_day, start_date, end_date, active, created_at, updated_at)
            VALUES (:patient_id, :medication_id, :name_override, :dosage, :frequency_per_day, :start_date, :end_date, 1, NOW(), NOW())
        ");
    ...
    public function logIntake(array $d): int
    {
        $stmt = $this->db->prepare("
            ...
            (patient_medication_id, taken_at, status, created_at)
            VALUES (:pmid, :taken_at, :status, NOW())
        ");
