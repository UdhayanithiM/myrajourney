...
public class PatientDetailsActivity extends AppCompatActivity {
    ...
    private void initializePatientReports() {
        ...
        // Sample reports for the patient using the correct constructor
        reportsList.add(new Report("Blood Test Results", "2024-01-15", "file://blood_test_2024.pdf"));
        reportsList.add(new Report("X-Ray - Joints", "2024-01-10", "file://xray_joints_2024.jpg"));
        reportsList.add(new Report("MRI Scan", "2024-01-05", "file://mri_scan_2024.pdf"));
        reportsList.add(new Report("Rheumatoid Factor Test", "2023-12-20", "file://rf_test_2023.pdf"));
        reportsList.add(new Report("Joint Ultrasound", "2023-12-15", "file://ultrasound_joints_2023.jpg"));
        reportsList.add(new Report("Bone Density Scan", "2023-12-10", "file://bone_density_2023.pdf"));
