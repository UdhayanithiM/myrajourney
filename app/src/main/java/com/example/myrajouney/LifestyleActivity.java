...
public class LifestyleActivity extends AppCompatActivity {
    ...
    private String generateLifestyleContent() {
        ...
        html.append("        <h1>🏃‍♀️ Lifestyle Recommendations for RA</h1>\n");
        html.append("\n");
        ...
        html.append("            <h2>💪 Exercise Guidelines</h2>\n");
        ...
        html.append("\n");
        html.append("        <div class=\"section\">\n");
        html.append("            <h2>🛡️ Joint Protection Strategies</h2>\n");
        html.append("            <div class=\"subsection\">\n");
        ...
        html.append("\n");
        html.append("        <div class=\"section\">\n");
        html.append("            <h2>😴 Sleep and Rest</h2>\n");
        html.append("            <div class=\"subsection\">\n");
        ...
        html.append("            <strong>💡 Remember:</strong> Listen to your body. Exercise should make you feel better, not worse. If you experience increased pain, stop and consult your healthcare provider.\n");
        html.append("        </div>\n");
        html.append("    </div>\n");
        html.append("</body>\n");
        html.append("</html>\n");
