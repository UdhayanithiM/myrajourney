...
public class ReportDetailsActivity extends AppCompatActivity {
    ...
    private void loadReportNotes(String reportId) {
        ...
        retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.ReportNote>>> call = apiService.getReportNotes(reportId);
        
        call.enqueue(new retrofit2.Callback<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.ReportNote>>>() {
            @Override
            public void onResponse(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.ReportNote>>> call,
                                 retrofit2.Response<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.ReportNote>>> response) {
                if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
                    List<com.example.myrajouney.api.models.ReportNote> notes = response.body().getData();
                    if (notes != null && !notes.isEmpty()) {
                        // Load the most recent note
                        com.example.myrajouney.api.models.ReportNote latestNote = notes.get(0);
            ...
            @Override
            public void onFailure(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.ReportNote>>> call, Throwable t) {
    ...
    private void saveDiagnosisToBackend(String reportId, String diagnosis, String suggestions) {
        ...
        com.example.myrajouney.api.ApiService apiService = com.example.myrajouney.api.ApiClient.getApiService(this);
        retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.ReportNote>> call = apiService.createReportNote(request);
        
        call.enqueue(new retrofit2.Callback<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.ReportNote>>() {
            @Override
            public void onResponse(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.ReportNote>> call,
                                 retrofit2.Response<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.ReportNote>> response) {
                if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
            ...
            @Override
            public void onFailure(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.ReportNote>> call, Throwable t) {
