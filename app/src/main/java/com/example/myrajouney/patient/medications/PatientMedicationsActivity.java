package com.example.myrajouney.patient.medications;
...
public class PatientMedicationsActivity extends AppCompatActivity {
    ...
    private List<com.example.myrajouney.api.models.Medication> allMedications;
    ...
    private void logMedicationIntake(String medicationName, String dosage) {
        ...
        for (com.example.myrajouney.api.models.Medication med : getAllMedications()) {
        ...
        com.example.myrajouney.api.models.MedicationLogRequest request = new com.example.myrajouney.api.models.MedicationLogRequest();
        ...
        retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.MedicationLog>> call = apiService.logMedicationIntake(request);
        
        call.enqueue(new retrofit2.Callback<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.MedicationLog>>() {
            @Override
            public void onResponse(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.MedicationLog>> call, 
                                 retrofit2.Response<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.MedicationLog>> response) {
                // Medication logged successfully - doctor will be notified
            }
            
            @Override
            public void onFailure(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.MedicationLog>> call, Throwable t) {
                // Logging failed - but local status is saved
            }
        });
    }
    
    private List<com.example.myrajouney.api.models.Medication> getAllMedications() {
