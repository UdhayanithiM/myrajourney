package com.example.myrajouney.patient.symptoms;
...
public class SymptomLogActivity extends AppCompatActivity {
    ...
    private void saveSymptomToBackend(int painLevel, int stiffnessLevel, int fatigueLevel, String notes) {
        ...
        com.example.myrajouney.api.models.SymptomRequest request = new com.example.myrajouney.api.models.SymptomRequest(
            patientId,
            date,
            painLevel,
            stiffnessLevel,
        ...
        retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Symptom>> call = apiService.createSymptom(request);
        
        call.enqueue(new retrofit2.Callback<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Symptom>>() {
            @Override
            public void onResponse(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Symptom>> call,
                                 retrofit2.Response<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Symptom>> response) {
            ...
            @Override
            public void onFailure(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Symptom>> call, Throwable t) {
