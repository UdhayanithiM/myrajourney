...
public class UploadReportActivity extends AppCompatActivity {
    ...
    private void uploadReportToBackend(String title, String date) {
        ...
        try {
            ...
            retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Report>> call = 
                apiService.createReport(patientIdBody, titleBody, descriptionBody, filePart);
            
            submitButton.setEnabled(false);
            submitButton.setText("Uploading...");
            
            call.enqueue(new retrofit2.Callback<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Report>>() {
                @Override
                public void onResponse(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Report>> call,
                                     retrofit2.Response<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Report>> response) {
                ...
                @Override
                public void onFailure(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Report>> call, Throwable t) {
                    submitButton.setEnabled(true);
                    submitButton.setText("Submit");
