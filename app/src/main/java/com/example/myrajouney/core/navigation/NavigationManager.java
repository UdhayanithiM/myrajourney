package com.example.myrajouney.core.navigation;
...
import com.example.myrajouney.AdminDashboardActivity;
import com.example.myrajouney.DoctorDashboardActivity;
import com.example.myrajouney.LoginActivity;
import com.example.myrajouney.OnboardingActivity;
import com.example.myrajouney.PatientDashboardActivity;
...
public final class NavigationManager {
    ...
    public static void goToDashboardForRole(@NonNull Context context, String role) {
        ...
        if (role == null) {
            Log.e(TAG, "Null role → Sending to Login!!");
            goToLogin(context);
            return;
        }
