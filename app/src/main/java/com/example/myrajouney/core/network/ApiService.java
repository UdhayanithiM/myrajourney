...
import com.example.myrajouney.data.model.ActiveRequest;
import com.example.myrajouney.data.model.ApiResponse;
import com.example.myrajouney.data.model.AppointmentRequest;
import com.example.myrajouney.data.model.AuthRequest;
import com.example.myrajouney.data.model.AuthResponse;
import com.example.myrajouney.data.model.CreateUserRequest;
import com.example.myrajouney.data.model.Doctor;
import com.example.myrajouney.data.model.DoctorOverview;
import com.example.myrajouney.data.model.EducationArticle;
import com.example.myrajouney.data.model.Medication;
import com.example.myrajouney.data.model.MedicationLog;
import com.example.myrajouney.data.model.MedicationLogRequest;
import com.example.myrajouney.data.model.MedicationRequest;
import com.example.myrajouney.data.model.Notification;
import com.example.myrajouney.data.model.PatientOverview;
import com.example.myrajouney.data.model.RehabPlan;
import com.example.myrajouney.data.model.Report;
import com.example.myrajouney.data.model.ReportNote;
import com.example.myrajouney.data.model.ReportRequest;
import com.example.myrajouney.data.model.Settings;
import com.example.myrajouney.data.model.SettingsRequest;
import com.example.myrajouney.data.model.Symptom;
import com.example.myrajouney.data.model.SymptomRequest;
import com.example.myrajouney.data.model.User;
import com.example.myrajouney.data.model.UserResponse;
