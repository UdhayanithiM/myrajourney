package com.example.myrajouney.common.appointments;
...
public class AddAppointmentActivity extends AppCompatActivity {
    ...
    private void saveAppointmentToBackend(String patientName, String doctorName, String reason, String timeSlot) {
        ...
        com.example.myrajouney.api.models.AppointmentRequest request =
                new com.example.myrajouney.api.models.AppointmentRequest(
                        patientId,
                        doctorId,
        ...
        retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Appointment>> call =
                apiService.createAppointment(request);

        call.enqueue(new retrofit2.Callback<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Appointment>>() {
            @Override
            public void onResponse(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Appointment>> call,
                                   retrofit2.Response<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Appointment>> response) {
            ...
            @Override
            public void onFailure(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Appointment>> call, Throwable t) {
    ...
    private void findUserIdsAndSave(String patientName, String doctorName, String reason, String startTime, String endTime) {
        ...
        call.enqueue(new retrofit2.Callback<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.User>>>() {
            @Override
            public void onResponse(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.User>>> call,
                                   retrofit2.Response<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.User>>> response) {
                ...
                retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Appointment>> createCall =
                        apiService.createAppointment(request);

                createCall.enqueue(new retrofit2.Callback<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Appointment>>() {
                    @Override
                    public void onResponse(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Appointment>> call,
                                           retrofit2.Response<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.Appointment>> response) {
                        if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
