...
public class DoctorScheduleActivity extends AppCompatActivity {
    ...
    private void loadAppointmentsFromBackend() {
        ...
        retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.Appointment>>> call = apiService.getAppointments();
        
        call.enqueue(new retrofit2.Callback<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.Appointment>>>() {
            @Override
            public void onResponse(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.Appointment>>> call, 
                                 retrofit2.Response<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.Appointment>>> response) {
            ...
            @Override
            public void onFailure(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.Appointment>>> call, Throwable t) {
