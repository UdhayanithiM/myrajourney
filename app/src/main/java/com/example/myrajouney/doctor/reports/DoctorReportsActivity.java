package com.example.myrajouney.doctor.reports;
...
public class DoctorReportsActivity extends AppCompatActivity {
    ...
    private void loadReportsFromBackend() {
        ...
        Call<ApiResponse<List<com.example.myrajouney.api.models.Report>>> call = apiService.getReports();
        
        call.enqueue(new Callback<ApiResponse<List<com.example.myrajouney.api.models.Report>>>() {
            @Override
            public void onResponse(Call<ApiResponse<List<com.example.myrajouney.api.models.Report>>> call, Response<ApiResponse<List<com.example.myrajouney.api.models.Report>>> response) {
            ...
            @Override
            public void onFailure(Call<ApiResponse<List<com.example.myrajouney.api.models.Report>>> call, Throwable t) {
    ...
    private String determineStatus(com.example.myrajouney.api.models.Report apiReport) {
