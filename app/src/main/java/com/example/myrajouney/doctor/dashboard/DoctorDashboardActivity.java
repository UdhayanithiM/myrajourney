package com.example.myrajouney.doctor.dashboard;
...
public class DoctorDashboardActivity extends AppCompatActivity {
    ...
    private void loadStatisticsFromBackend() {
        ...
        retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.DoctorOverview>> call = apiService.getDoctorOverview();
        
        call.enqueue(new retrofit2.Callback<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.DoctorOverview>>() {
            @Override
            public void onResponse(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.DoctorOverview>> call, retrofit2.Response<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.DoctorOverview>> response) {
                if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
                    com.example.myrajouney.api.models.DoctorOverview overview = response.body().getData();
                    if (overview != null) {
            ...
            @Override
            public void onFailure(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<com.example.myrajouney.api.models.DoctorOverview>> call, Throwable t) {
                // On failure, show 0
                totalPatients = 0;
                activePatientsToday = 0;
                updateStatistics();
    ...
    private void loadNotificationsFromBackend() {
        com.example.myrajouney.api.ApiService apiService = com.example.myrajouney.api.ApiClient.getApiService(this);
        retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.Notification>>> call = apiService.getNotifications(1, 5, true);
        
        call.enqueue(new retrofit2.Callback<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.Notification>>>() {
            @Override
            public void onResponse(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.Notification>>> call, 
                                 retrofit2.Response<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.Notification>>> response) {
                List<com.example.myrajouney.api.models.Notification> notifications = new ArrayList<>();
                if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
            ...
            @Override
            public void onFailure(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.Notification>>> call, Throwable t) {
    ...
    private void loadPatientsFromBackend() {
        ...
        com.example.myrajouney.api.ApiService apiService = com.example.myrajouney.api.ApiClient.getApiService(this);
        retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.User>>> call = apiService.getAllPatients();
        
        call.enqueue(new retrofit2.Callback<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.User>>>() {
            @Override
            public void onResponse(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.User>>> call, retrofit2.Response<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.User>>> response) {
                if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
                    List<com.example.myrajouney.api.models.User> users = response.body().getData();
                    if (users != null) {
                        patientsList.clear();
                        for (com.example.myrajouney.api.models.User user : users) {
            ...
            @Override
            public void onFailure(retrofit2.Call<com.example.myrajouney.api.models.ApiResponse<List<com.example.myrajouney.api.models.User>>> call, Throwable t) {
                // On failure, show empty list
                PatientsAdapter patientsAdapter = new PatientsAdapter(DoctorDashboardActivity.this, patientsList);
                LinearLayoutManager patientsLayoutManager = new LinearLayoutManager(DoctorDashboardActivity.this);
                patientsRecycler.setLayoutManager(patientsLayoutManager);
